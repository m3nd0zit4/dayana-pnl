...
2. Tras crear, el asistente pregunta **¿Agregar servicio?** — elige producto y opcionalmente **Activar ya**.
...
5. Cambia estado a **Activo** cuando corresponda (solo **una terapia ACTIVE** por contacto).
