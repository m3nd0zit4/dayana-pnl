...
const NotificationItem = ({
  ...
  const titleClass = cn(
    ...
    "text-left text-sm font-medium text-foreground after:absolute after:inset-0 after:content-[''] focus-visible:outline-none",
  ...
  return (
    <div
      className={cn(
        "group/notification relative flex gap-3 px-3 py-3 transition-colors hover:bg-muted/60 focus-within:bg-muted/60",
