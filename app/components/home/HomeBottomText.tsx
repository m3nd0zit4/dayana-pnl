...
/** +573105833188 → +57 310 583 3188 */
const phoneDisplay =
  phoneDigits.startsWith("57") && phoneDigits.length >= 12
...
const HomeBottomText = () => {
  ...
  return (
    <div className="font-[font2] flex flex-col items-center justify-center gap-4 px-4 pb-6 lg:pb-0 relative z-10">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-3 lg:gap-4 w-full">
        <a
          href="#testimonios"
      ...
      <div className="flex flex-col items-center gap-1 text-center max-w-md">
        <p className="font-[font1] text-[11px] lg:text-xs uppercase tracking-[0.22em] text-white/55">
          Si el enlace no abre (p. ej. desde TikTok o Instagram), escríbenos
          al mismo número:
        </p>
        <a
          href={phoneTelHref}
          className="font-[font1] text-lg lg:text-xl text-white hover:text-linen transition-colors tracking-wide"
        >
          {phoneDisplay}
        </a>
      </div>
